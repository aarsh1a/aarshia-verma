...
export default class Experience {
    ...
    constructor(_options = {}) {
        ...
        this.setWorld()
        this.ui = {}
        // Query UI elements after a small delay to ensure they're rendered
        setTimeout(() => {
    ...
    destroy() {
        ...
        if (this.renderer && this.renderer.instance && this.renderer.instance.domElement) {
            this.renderer.instance.domElement.remove();
        }

        // Reset Noises singleton
        const Noises = require('./Noises.js').default;
        if (Noises.instance) {
